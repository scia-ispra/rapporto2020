...
nomeA<-list.files(pattern=sprintf("Tmean.+\\.csv$",PARAM))
...
- Dal calcolo e' stata invalidata (per il 2020) la stazione "sicilia_56" per l'andamento strano di temperatura minima nel 2020

- Dal calcolo e' stata invalidata (per il 2020) la stazione "aosta_57" per le anomalie di temperatura minima nel 2020 particolarmente alte
...
ggplot()+
  ...
  scale_fill_scico(palette="vik",limits=c(-7,7))+
